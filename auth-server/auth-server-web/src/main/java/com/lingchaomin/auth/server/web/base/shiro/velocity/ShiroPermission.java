package com.lingchaomin.auth.server.web.base.shiro.velocity;
 ...
 * @author minlingchao
 * @version 1.0
 * @date 2017/3/14 上午10:55
 * @description shiro velocity 支持
 */
public class ShiroPermission {
    ...
    public boolean hasPermission(String permission) {
        ...
        logger.debug("验证用户是否具备某权限:permission:{},isHas:{}",permission,subject != null && subject.isPermitted(permission));
